        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-500 text-[13px] leading-relaxed">
              Representando o espirito and passion of Oliveira de Azemeis since 1922. A casa dos bravos.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <button className="px-3 py-2 rounded text-sm font-bold text-white" style={{ background: "#bd001b" }}>SUBSCREVER</button>
            </div>
          </div>
        </div>
